...
activities = {
    ...
    "Tennis Team": {
        "description": "Join the school tennis team and compete in inter-school matches",
        "schedule": "Mondays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 10,
        "participants": ["ethan@mergington.edu", "aiden@mergington.edu"]
        },
        "Volleyball Team": {
        "description": "Join the school volleyball team and compete in inter-school matches",
        ...
        "max_participants": 10,
        "participants": ["amelia@mergington.edu", "lily@mergington.edu"]
        },
        "Debate Team": {
        ...
        "max_participants": 18,
        "participants": ["jackson@mergington.edu", "liam@mergington.edu"]
        },
    "Drama Club": {
